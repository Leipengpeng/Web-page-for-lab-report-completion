...
def homeWorkDown():
    if request.method == 'POST':
        ...
        outputS=short(output)
        outputO = out(outputS,outputP)
        front=r"C:\Users\WHUT\AppData\Local\Programs\Python\Python310\python.exe C:/Users/WHUT/Desktop/homeWork/main.py"
        end=r"进程已结束,退出代码0"
        outputO=front+"\n"+outputO+"\n"+end
...
@app.route('/languageSelect', methods=['POST'])
def languageSelect():
    language = request.form['language-select']
    print(language)
